...
class InterfaceEC():
    ...
    def get_offspring(self, pop, operator):
        ...
        try:
            ...
            if self.debug:
                print(f"Error in get_offspring [{operator}]: {e}")
                if 'offspring' in locals():
                    print(f"Offspring algorithm: {offspring.get('algorithm')}")
                    print(f"Offspring code: {offspring.get('code')}")
